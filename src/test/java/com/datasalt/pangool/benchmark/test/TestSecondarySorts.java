...
public class TestSecondarySorts extends BaseBenchmarkTest {
	...
	private final static String OUT_CASCADING = "out-cascading-ss";
	private final static String OUT_CRUNCH = "out-crunch-ss";
	private final static String OUT_HADOOP = "out-mapred-ss";
