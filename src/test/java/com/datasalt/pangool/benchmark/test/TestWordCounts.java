...
public class TestWordCounts extends BaseBenchmarkTest {
	...
	private final static String OUT_PANGOOL = "out-pangool-wc";
	private final static String OUT_CASCADING = "out-cascading-wc";
	private final static String OUT_CRUNCH = "out-crunch-wc";
	private final static String OUT_MAPRED = "out-mapred-wc";
